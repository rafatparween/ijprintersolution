...
const InstallingDriversPage = () => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white w-[500px] h-[300px] rounded-lg shadow-lg flex flex-col justify-center items-center">
...
export default InstallingDriversPage;
