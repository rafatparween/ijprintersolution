...
//           style={{
//             backgroundImage:
//               "url('https://as1.ftcdn.net/v2/jpg/05/21/66/12/1000_F_521661218_MNYc5lCrIQUKKwBfIGzxJYHYxZzwNof9.jpg')",
//           }}
//         >
...
//                   className="border border-white mt-8 bg-white w-[230px] h-[50px] py-2 px-6 rounded-lg font-bold shadow-md hover:bg-gray-100 transition duration-300"
//                 >
...
//           <div className="bg-white w-[400px] h-[300px] rounded-lg shadow-lg p-6 flex flex-col justify-center items-center">
//             <h2 className="text-lg font-semibold mb-4">Gathering device details...</h2>
//             <svg
