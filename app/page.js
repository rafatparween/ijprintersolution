...
function Home() {
  ...
  const handleSearchClick = () => {
    if (searchTerm) {
      ...
      router.push(`./install?model=${encodeURIComponent(searchPath)}`); // Navigate to the install page
    } else {
      ...
      <div className="h-[409px] ">
        ...
        >
          ...
          <div className="relative z-10 text-white 2xl:mt-[117px] xl:mt-[165px] 2xl:ml-[-825px] xl:ml-[-567px]  ">
            <h1 className="text-4xl font-hp-simplified text-[44px] 2xl:ml-[-24px] xl:ml-[-62px]">Get started with your HP printer</h1>
            <p className="mt-[35px] text-[24px] xl:ml-[214px] 2xl:ml-[253px]">Enter your printer name and model number to get the right HP software and drivers.</p>
            ...
            {filteredModels.length > 0 && (
              <ul className="absolute left-0 mt-1 w-full max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg z-10 2xl:ml-[256px] xl:ml-[213px] text-black">
